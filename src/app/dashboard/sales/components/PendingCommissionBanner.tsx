...
import { PendingCommissionBannerProps } from "../types";
...
export default function PendingCommissionBanner({
  ...
  return (
    <div className='rounded-2xl border border-amber-100 bg-amber-50/60 px-5 py-4 flex items-center gap-4'>
      <div className='shrink-0 p-2.5 rounded-xl bg-amber-100 text-amber-600'>
      ...
      <p className='text-xl font-bold text-amber-600 tabular-nums shrink-0'>
